                        ...
                        <div class="col-lg-7 col-md-12 col-sm-12">
                            <div class="pt-40 pb-30 pl-30 pr-30"><a class="btn btn-tag" href="blog-grid.html">Marketing</a>
                                <h2 class="mt-20 mb-20"><a href="blog-details.html">Improve Your Business With These 8
                                        Simple Tricks</a></h2>
                                <p class="font-md mb-20">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
                                    laoreet rutrum quam, id faucibus erat interdum a. Curabitur eget tortor a nulla interdum
                                    semper. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam laoreet rutrum
                                    quam, id faucibus erat interdum a. Curabitur eget tortor a nulla interdum semper.</p>
                                <div><a class="btn btn-arrow-right" href="blog-details.html">Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="post-loop-grid">
                <div class="container">
                    <div class="text-left">
                        ...
                        <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Don&apos;t miss
                            the trending news</p>
                    </div>
                    <div class="row mt-30">
                        <div class="col-lg-8">
                                ...
                                <div class="col-lg-6 mb-30">
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <h5><a @click="navigateToBlogDetails" class="item-details">21 Job Interview
                                                    Tips: How To Make a Great
                                                    Impression</a></h5>
                                                    ...
                                                    <div class="col-lg-6 col-6">
                                                        <div class="d-flex"><img class="img-rounded"
                                                            ...
                                                            <div class="info-right-img"><span
                                                                    class="font-sm font-bold color-brand-1 op-70">Azumi
                                                                    Rose</span><br><span
                                                                    class="font-xs color-text-paragraph-2">25 April
                                                                    2022</span></div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="col-lg-6 mb-30">
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <h5><a href="blog-details.html">Email Examples: How To Respond to Employer
                                                    Interview Requests</a></h5>
                                            <p class="mt-10 color-text-paragraph font-sm">Our mission is to create the
                                                world&amp;rsquo;s most sustainable healthcare company by creating
                                                high-quality healthcare products in iconic, sustainable packaging.</p>
                                            <div class="card-2-bottom mt-20">
                                ...
                                <div class="col-lg-6 mb-30">
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <h5><a href="blog-details.html">How To Write an Application Letter (With
                                                    Examples)</a></h5>
                                            <p class="mt-10 color-text-paragraph font-sm">Our mission is to create the
                                                world&amp;rsquo;s most sustainable healthcare company by creating
                                                high-quality healthcare products in iconic, sustainable packaging.</p>
                                ...
                                <div class="col-lg-6 mb-30">
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <h5><a href="blog-details.html">17 Jobs That Hire at Age 15 (and Even 14)</a>
                                            </h5>
                                            <p class="mt-10 color-text-paragraph font-sm">Our mission is to create the
                                                world&amp;rsquo;s most sustainable healthcare company by creating
                                                high-quality healthcare products in iconic, sustainable packaging.</p>
                                ...
                                <div class="col-lg-6 mb-30">
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <h5><a href="blog-details.html">How To Write a Cover Letter (Plus Tips and
                                                    Examples)</a></h5>
                                            <p class="mt-10 color-text-paragraph font-sm">Our mission is to create the
                                                world&amp;rsquo;s most sustainable healthcare company by creating
                                                high-quality healthcare products in iconic, sustainable packaging.</p>
                                ...
                                <div class="col-lg-6 mb-30">
                                    <div class="card-grid-3 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <h5><a href="blog-details.html">List of Weaknesses: 10 Things To Say in an
                                                    Interview</a></h5>
                                            <p class="mt-10 color-text-paragraph font-sm">Our mission is to create the
                                                world&amp;rsquo;s most sustainable healthcare company by creating
                                                high-quality healthcare products in iconic, sustainable packaging.</p>
