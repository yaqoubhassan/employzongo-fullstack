            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tab-short-bio" role="tabpanel"
                                    ...
                                    <p>Hello there! My name is Alan Walker. I am a graphic designer, and I&rsquo;m very
                                        passionate and dedicated to my work. With 20 years experience as a professional a
                                        graphic designer, I have acquired the skills and knowledge necessary to make your
                                        project a success.</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis illum fuga eveniet.
                                        Deleniti asperiores, commodi quae ipsum quas est itaque, ipsa, dolore beatae
                                        voluptates nemo blanditiis iste eius officia minus. Id nisi, consequuntur sunt
                                    ...
                                    <div class="row mb-40">
                                        <div class="col-lg-6 col-md-6 col-sm-12 mb-30">
                                            ...
                                            <div class="box-progress-bar mt-20">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-brand-2" role="progressbar"
                                                        style="width: 88%" aria-valuenow="50" aria-valuemin="0"
                                                        aria-valuemax="100"><span>88%</span></div>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="tab-skills" role="tabpanel" aria-labelledby="tab-skills">
                                    ...
                                    graphic designer, I have acquired the skills and knowledge necessary to make your
                                    project a success.
                                    <p></p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis illum fuga
                                    eveniet. Deleniti asperiores, commodi quae ipsum quas est itaque, ipsa, dolore beatae
                                    voluptates nemo blanditiis iste eius officia minus. Id nisi, consequuntur sunt impedit
                                            ...
                                            <div class="card-2-bottom mt-20">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-5 col-5 text-end"><a class="btn btn-apply-now"
                                                            href="job-details.html">View Details</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                        <div class="sidebar-border">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="sidebar-text-info"><span
                                                class="text-description">Experience</span><strong class="small-heading">12
                                                years</strong></div>
                                    </li>
                                    <li>
                            ...
                            <div class="sidebar-list-job">
                                <ul class="ul-disc">
                                    ...
                                    <li>Email: <a href="https://wp.alithemes.com/cdn-cgi/l/email-protection"
                                            class="__cf_email__"
                                            data-cfemail="43202c2d372220370306352231226d202c2e">[email&#160;protected]</a>
                                    </li>
                                </ul>
                        ...
                        <div class="sidebar-border-bg bg-right"><span class="text-grey">WE ARE</span><span
