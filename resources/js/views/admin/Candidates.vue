                                                ...
                                                <div class="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                                                    <div class="display-flex2">
                                                        ...
                                                        <div class="box-view-type"><a class="view-type"
                                                                href="jobs-list.html"><img
                                                                    src="../../../assets/admin/imgs/template/icons/icon-list.svg"
                                                                    alt="EmployZongo"></a><a class="view-type"
                                                                href="jobs-grid.html"><img
                                                                    src="../../../assets/admin/imgs/template/icons/icon-grid-hover.svg"
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user1.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                    ...
                                                    <div class="rate-reviews-small pt-5"><span><img
                                                                src="../../../assets/admin/imgs/template/icons/star.svg"
                                            ...
                                            <div class="card-block-info">
                                                <p class="font-xs color-text-paragraph-2">| Lorem ipsum dolor sit amet
                                                    consectetur adipisicing elit. Vero repellendus magni, atque delectus
                                                    molestias quis?</p>
                                                <div class="card-2-bottom card-2-bottom-candidate mt-30">
                                                    <div class="text-start"><a class="btn btn-tags-sm mb-10 mr-5"
                                                            ...
                                                            class="btn btn-tags-sm mb-10 mr-5"
                                                            href="jobs-grid.html">Digital</a><a
                                                            class="btn btn-tags-sm mb-10 mr-5" href="jobs-grid.html">Adobe
                                                            Illustrator</a><a class="btn btn-tags-sm mb-10 mr-5"
                                                            href="jobs-grid.html">Sketch</a>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6"><span
                                                                class="d-flex justify-content-end align-items-center"><i
                                                                    ...
                                                                    class="font-sm color-brand-1">$45 / hour</span></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user2.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Cody Fisher</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user3.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Jerome Bell</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user4.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Jane Cooper</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user5.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Floyd Miles</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user6.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Devon Lane</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user7.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Jerome Bell</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user8.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Eleanor</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user9.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Theresa</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user10.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Robert Fox</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user11.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Cameron</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user12.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Jacob Jones</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user13.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Court Henry</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user14.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Hawkins</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-6">
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                <div class="card-grid-2-image-rd online"><a href="candidate-details.html">
                                                        <figure><img alt="EmployZongo"
                                                                src="../../../assets/admin/imgs/page/candidates/user15.png">
                                                        </figure>
                                                    </a></div>
                                                <div class="card-profile pt-10"><a href="candidate-details.html">
                                                        <h5>Howard</h5>
                                            ...
                                            <div class="card-block-info">
                                                ...
                                                <div class="card-2-bottom card-2-bottom-candidate mt-30">
                                                    <div class="text-start"><a class="btn btn-tags-sm mb-10 mr-5"
                                                            ...
                                                            class="btn btn-tags-sm mb-10 mr-5"
                                                            href="jobs-grid.html">App</a><a
                                                            class="btn btn-tags-sm mb-10 mr-5" href="jobs-grid.html">Digital
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="employers-info align-items-center justify-content-center mt-15">
