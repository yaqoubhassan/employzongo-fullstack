                        ...
                        <div class="box-border-single">
                            <div class="row mt-10">
                                <div class="col-lg-8 col-md-12">
                                    ...
                                    <div class="mt-0 mb-15"><span class="card-briefcase">Fulltime</span><span
                            ...
                            <div class="content-single">
                                ...
                                <p>
                                    ...
                                    have
                                    experiences in working with numerous different design platforms such as digital
                                    and print forms.
                                </p>
                                ...
                                <p><strong>Communication:</strong> Communicate the results of UX activities within your
                                    product
                                    area to the design team department, cross-functional partners within your product area,
                                    and
                                    other interested Superformula team
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                        ...
                        <div class="sidebar-border">
                            ...
                            <div class="sidebar-list-job"><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">App</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Digital</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Marketing</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Conten Writer</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Sketch</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">PSD</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Laravel</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">React JS</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">HTML</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Finance</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Manager</a><a class="btn btn-grey-small bg-14 mb-10 mr-5"
                                    href="jobs-grid.html">Business</a></div>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-30"><a class="btn btn-grey-small mr-5"
                                                    ...
                                                    href="job-details.html">Android </a></div>
                                    ...
                                    <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-30"><a class="btn btn-grey-small mr-5"
                                                    ...
                                                    href="jobs-grid.html">Java</a></div>
                                            <div class="card-2-bottom mt-30">
                                                <div class="row">
                                                    <div class="col-lg-7 col-7"><span
                                    ...
                                    <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-30"><a class="btn btn-grey-small mr-5"
                                                    ...
                                                    href="job-details.html">Golang</a></div>
                                            <div class="card-2-bottom mt-30">
                                                <div class="row">
                                                    <div class="col-lg-7 col-7"><span
                                                            class="card-text-price">$250</span><span
