        ...
        <div class="container">
            <div class="row login-register-cover">
                <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
                    <div class="text-center">
                        ...
                        <button class="btn social-login hover-up mb-20"><img
                                src="../../../assets/imgs/template/icons/icon-google.svg" alt="EmployZongo"><strong>Sign up with
                ...
                <div class="img-1 d-none d-lg-block"><img class="shape-1"
                        src="../../../assets/imgs/page/login-register/img-1.svg" alt="EmployZongo"></div>
                <div class="img-2"><img src="../../../assets/imgs/page/login-register/img-2.svg" alt="EmployZongo"></div>
            </div>
        </div>
    </section>
</template>
